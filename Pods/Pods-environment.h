...
// BRORM
#define COCOAPODS_POD_AVAILABLE_BRORM
#define COCOAPODS_VERSION_MAJOR_BRORM 0
#define COCOAPODS_VERSION_MINOR_BRORM 3
#define COCOAPODS_VERSION_PATCH_BRORM 0
